...
function Login({ onRegisterClick }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="login container-fluid d-flex flex-column justify-content-center align-items-center p-5 m-5" style={{ height: '100vh' }}>
      <img className="img-fluid mb-2" src={logoUsuario} alt="User Logo" style={{ maxHeight: '110px' }} />
      <p className="font-weight-bold fs-1 mb-1">Login</p>
      <p>No tienes cuenta? <a className="text-white" onClick={onRegisterClick}>Regístrate</a></p>
