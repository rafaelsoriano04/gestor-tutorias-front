...
const Informe = () => {
  ...
  const handleDateChange = (e) => {
    ...
    const currentDate = new Date(informe.fecha); // Asegúrate de que 'informe.fecha' es accesible y está en el formato adecuado
    ...
    setInforme((prevInforme) => ({
      ...prevInforme,
      fecha: e.target.value, // Asegúrate de que e.target.value esté en el formato correcto
    }));
